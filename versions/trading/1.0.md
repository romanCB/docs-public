...
1.3 | 2017-10-24 | Add lose event to the protocol in case a player lose the game. Remove amount from bet cancel. Add optional wallet identifier for REST like communication. | Krzysztof Bończak
