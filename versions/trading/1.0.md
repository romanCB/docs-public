...
The request sends to the integration party from the domain party to get the actual account balance volume on trader account.
...
The request sends to the integartion party in case the betting order occured.
