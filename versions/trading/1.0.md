...
**Trader** - trader is a synonym of player and is used interchangeably in the technical description
...
Authentication: Bearer `authToken` for http calls mechanism only, uniquely identifies a trader/player  
Http verb: `PUT`  
Path: `bet/[integrationPartyBetId]` - comes from Bet operation http header Location resource  
