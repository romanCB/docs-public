...
Each queue name should be prefixed with protocol version it is supporting (one protocol version per queue/exchange). The pattern is as follow: `v1.0.orders.open`. Both major and minor part of protocol version number is important.  
