...
1.2 | 2017-10-20 | Reformatting the protocol description, add additional comments, remote yaml examples. | Krzysztof Bończak
...
Sends to the integration party to get the actual account balance volume on trader account.

##### **Http** REST like protocols:
