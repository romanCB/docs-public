...
The Cryptogames representation of the integration API is made of a single file. However, parts of the definitions can be split into separate files, at the discretion of the user. This is applicable for `$ref` fields in the specification as follows from the [JSON Schema] definitions.

By convention, the Cryptogames Integration specification file is named `integration.json`.
